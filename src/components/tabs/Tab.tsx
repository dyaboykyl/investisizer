  ...
  return (
    ...
    >
      ...
      {closable && (
        <span
          onClick={handleClose}
          className="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 rounded hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center transition-colors"
        >
          <svg
            className="w-3 h-3"
            fill="none"
